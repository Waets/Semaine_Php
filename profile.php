                ...
                <div class="panel-body">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="user-profile-payments">
                            <p>
                                We will take care of your payment process so you don’t need to worry about chasing up
                                clients after every single project. We will do our best to ensure that you get paid
                                fairly and on a timely basis.
                                <br>
                                <br>
                                To set up the payment, please click on “Connect with Stripe” button below and follow the
                                instructions. It shouldn’t take more than 15 minutes to do so.
                                <br>
                                <br>
                        ...
                        <div class="tab-pane fade" id="user-profile-examples">
                            <div class="btn-Upload-group">
                                <a class="btn Upload flat btn-create btn-small"><i class="fa fa-camera"></i> Upload
                                    Photo</a>
                                <a href="#upload-video-url" data-toggle="modal"
                                   class="btn Upload flat btn-create btn-small"><i class="fa fa-video-camera"></i> Add
                                    Video URLs</a>
                            </div>
                        ...
                        <div class="tab-pane fade" id="user-profile-skills">
                            ...
                            <p>
                                In a few keywords, tell us what your skills are. These tags will be displayed on your
                                portfolio page so make sure you choose wisely.
                            </p>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body payment">
                ...
                <p>Add Vimeo and Youtube links of your recent and best videos. These will be displayed on your portfolio
                    page so choose the works that reflects your talents and expertise. First impression is important so
                    make it count.</p>
